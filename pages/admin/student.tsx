...
const Student = () => {
  ...
  return (
      ...
      <Heading textAlign={"center"} py={16}>All Student</Heading>   <Box display={"flex"} w={"100%"} alignItems={"end"} justifyContent={"end"} p={6}> <Button onClick={onOpen} rightIcon={<BsPlus />} colorScheme='blue' variant='outline'>
   Ajouter
  </Button></Box>
